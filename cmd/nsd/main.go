...
import (
	...
	"github.com/withzoo/nameservice/app"
...
func exportAppStateAndTMValidators(
	...
	return aApp.ExportAppStateAndValidators()
}
...
func InitCmd(ctx *server.Context, cdc *codec.Codec) *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			...
			genTime := tmtime.Now()
			if err = genutil.ExportGenesisFileWithTime(genFile, chainID, []tmtypes.GenesisValidator{validator}, appState, genTime); err != nil {
				return err
			}
...
`),
		RunE: func(_ *cobra.Command, args []string) error {
			...
			genTime := tmtime.Now()
			return genutil.ExportGenesisFileWithTime(genFile, genDoc.ChainID, genDoc.Validators, appStateJSON, genTime)
		},
	}
	return cmd
}
