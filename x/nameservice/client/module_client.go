...
import (
	...
	nameservicecmd "github.com/withzoo/nameservice/x/nameservice/client/cli"
)
...
func (mc ModuleClient) GetQueryCmd() *cobra.Command {
	...
	namesvcQueryCmd.AddCommand(flags.GetCommands(
...
func (mc ModuleClient) GetTxCmd() *cobra.Command {
	...
	namesvcTxCmd.AddCommand(flags.PostCommands(
